...
function aggElementi(contenuti){
    for(let i of contenuti){
        ...
        immaginePref.src="immagini/scheme_star_favorite_3421.png";
        let titolo=document.createElement("h1");
        let testo=document.createTextNode(i.taglia);
        ...
        imma.src="immagini/Pattini/"+i.immagini;
    
        let desc=document.createElement("p");
        desc.style.display="none";
        let paragrafo=document.createTextNode(i.modello);
    ...
    function aggPreferiti(event){
        ...
        let modello2=event.currentTarget.parentNode.querySelector("p").textContent;
        ...
        immaginePref2.src="immagini/star_favorite_favourite_16767.png";
     ...
     controllo();
     fetch(route("preferiti1",[titolo1,modello2])).then(onResponse).then(onJson); //fetch per l'aggiunta ai preferiti
    ...
    fetch(route("pattini")).then(onResponse).then(onJson);
